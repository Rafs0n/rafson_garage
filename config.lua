...
QBCore = exports['qb-core']:GetCoreObject() -- Uncomment if you're using qb-core
--ESX = exports["es_extended"]:getSharedObject() -- Uncomment if you're using esx
Config.Framework = 'QB' -- 'ESX' OR 'QB'
Config.Target = 'qb' -- 'qb' or 'ox'
Config.Locale = 'en' -- Select your language ('en/pl')
Config.ShowVIN = true -- Show vehicle VIN

Config.AllowVehicleSpawnInVehicle = false  -- player can spawn vehicle in vehicle

Config.ImpoundCheckMode = true -- true if you had (stored/state == 0) when impounded (recomended), false if you have (stored/state == 2)
Config.HideVehicleDistance = 30.0 -- Hide vehicle distance
Config.UsePedInteraction = true -- Use ped interaction
Config.PedModel = `s_m_m_autoshop_01` -- Ped Model

Config.Notify = function(msg) -- Custom notification
...
Config.GetVehicleFuel = function(vehicle) -- Get your fuel level
    return GetVehicleFuelLevel(vehicle)
	--return exports['LegacyFuel']:GetFuel(vehicle)
end

Config.SetVehicleFuel = function(vehicle, fuelLevel) -- Set your fuel level
	--exports['LegacyFuel']:SetFuel(vehicle, fuelLevel)
    SetVehicleFuelLevel(vehicle, fuelLevel)
end

function GivePlayerVehicleKeys(plate)
	-- Make your keys export if you're using custom key system
	TriggerEvent('vehiclekeys:client:SetOwner', plate) -- For qb-vehiclekeys
    -- exports["qs-keys"]:GiveKey(plate)
    -- exports["cd_keys"]:AddKeyToPlayer(plate)
    -- exports["madd_keys"]:GetVehicleKey(plate)
end


function RemovePlayerVehicleKeys(plate)
	-- Make your keys export if you're using custom key system
    -- exports["qs-keys"]:RemoveKey(plate)
    -- exports["cd_keys"]:RemoveKeyFromPlayer(plate)
    -- lub cokolwiek innego, w zależności od Twojego systemu.
end
...
Config.Garages = {
	['garage1'] = {
		...
		blips = {
			label = 'Garage',                    -- The blip's label/text
			blippoint = vector3(215.82, -808.8, 30.75), -- The main location for the blip
			showBlip = true,                    -- Whether or not to show the blip on the map
			blipsprite = 357,                   -- The sprite/icon ID for this blip
			blipscale = 0.65,                   -- The scaling of the blip
			blipcolour = 3,                     -- The color index of the blip
		},	
		target = {
			label = 'Open Garage',             -- Label when interacting with the ped/target
			icon = 'fas fa-warehouse',          -- Icon displayed in the menu
			distance = 2.5,                     -- Interaction distance
			PedModel = 's_m_m_autoshop_01',     -- Model for the ped that stands near the garage
			custompedposition = true,           -- If true, we can use a custom spawn location for the ped
			pedposition = vector4(214.8286, -806.7714, 30.8034, 347.6461), -- Coordinates (x,y,z) + heading for the ped
		},
    },
	['garage2'] = {
        label = 'Garage 2',
        ...
        target = {
            ...
            custompedposition = true,
            pedposition = vector4(-279.7936, -890.0259, 31.08061, 249.9214),
        },
    },
	['garage3'] = {
        label = 'Garage 3',
        ...
        target = {
            ...
            PedModel = 's_m_m_autoshop_01',
            custompedposition = true,
            pedposition = vector4(22.41191, 6341.533, 31.46344, 332.7072),
        },
    },
	['garage4'] = {
        label = 'Garage 4',
        ...
        target = {
            ...
            PedModel = 's_m_m_autoshop_01',
            custompedposition = true,
            pedposition = vector4(-2030.618, -467.532, 11.39225, 148.7124),
        },
    },
	['garage5'] = {
        label = 'Garage 5',
        ...
        target = {
            ...
            PedModel = 's_m_m_autoshop_01',
            custompedposition = true,
            pedposition = vector4(363.6053, 296.5923, 103.4957, 247.1678),
        },
    },
	['garage6'] = {
        label = 'Garage 6',
        ...
        target = {
            ...
            PedModel = 's_m_m_autoshop_01',
            custompedposition = true,
            pedposition = vector4(1134.928, 2661.118, 38.14392, 93.08868),
        },
    },
	['garage7'] = {
        label = 'Garage 7',
        ...
        target = {
            ...
            PedModel = 's_m_m_autoshop_01',
            custompedposition = true,
            pedposition = vector4(1852.609, 2582.208, 45.67202, 276.687),
        },
    },
	['depot'] = {
        label = 'Depot',
        ...
        target = {
            label = 'Open Depot Garage',
            icon = 'fas fa-warehouse',
            distance = 2.5,
            PedModel = 's_m_m_autoshop_01',
            custompedposition = true,
            pedposition = vector4(401.7924, -1626.113, 29.29194, 231.6363),
        },
    },
}